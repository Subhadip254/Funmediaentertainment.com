...
function TermsPage() {
  return (
    <section className="mx-auto max-w-4xl px-4 py-20">
      ...
      <div className="mt-12 space-y-8 text-sm text-gray-300">
        <div>
          <h2 className="text-white font-semibold text-lg">1. Use of Site and Services</h2>
        ...
        <div>
          <h2 className="text-white font-semibold text-lg">2. Intellectual Property Rights</h2>
        ...
        <div>
          <h2 className="text-white font-semibold text-lg">3. User Accounts and Employee Access</h2>
        ...
        <div>
          <h2 className="text-white font-semibold text-lg">4. Client Content and Licensing</h2>
        ...
        <div>
          <h2 className="text-white font-semibold text-lg">5. Payment and Billing Terms</h2>
        ...
        <div>
          <h2 className="text-white font-semibold text-lg">6. Limitation of Liability</h2>
        ...
        <div>
          <h2 className="text-white font-semibold text-lg">7. Indemnification</h2>
        ...
        <div>
          <h2 className="text-white font-semibold text-lg">8. Termination</h2>
        ...
        <div>
          <h2 className="text-white font-semibold text-lg">10. Modifications to Terms</h2>
        ...
        <div>
          <h2 className="text-white font-semibold text-lg">11. Contact Us</h2>
          <p className="mt-2">
